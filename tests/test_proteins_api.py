...
def test_get_info_on_taxID_string_id():
    expected = {
        ...
        "rank":
            "species",
        "parentLink":
            "https://www.ebi.ac.uk/proteins/api/taxonomy/id/9605",
        "childrenLinks": [
...
def test_tax_ids_info_several_ids_list():
    expected = [{
        ...
        "rank":
            "genus",
        "parentLink":
            "https://www.ebi.ac.uk/proteins/api/taxonomy/id/3201",
        "childrenLinks": [
        ...
        "rank":
            "species",
        "parentLink":
            "https://www.ebi.ac.uk/proteins/api/taxonomy/id/10487",
        "childrenLinks": [
        ...
        "rank":
            "species",
        "parentLink":
            "https://www.ebi.ac.uk/proteins/api/taxonomy/id/862507",
        "childrenLinks": [
