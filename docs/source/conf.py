...
latex_documents = [
    (master_doc, 'prunito.tex', 'prunito Documentation',
     'kp14', 'manual'),
]
...
man_pages = [
    (master_doc, 'prunito', 'prunito Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'prunito', 'prunito Documentation',
     author, 'prunito', 'One line description of project.',
     'Miscellaneous'),
]
